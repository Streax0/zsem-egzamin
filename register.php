...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($username === '') {
        ...
        $username = registrationGeneratedUsername($pdo, $first_name, $last_name, $classParts);
    }
        ...
        try {
            ...
            if ($existingAccount) {
                if (strcasecmp((string)$existingAccount['username'], $username) === 0) {
                    $suggestions = registrationUsernameSuggestions($pdo, $username, 2);
    ...
    <main class="auth-form-panel register-form-panel" role="main">
        ...
        <form method="POST" id="registerForm">
            ...
            <div class="mb-3">
                ...
                <input type="text" name="username" id="regUsername" class="form-control" placeholder="Puste = automatycznie, np. jan-k-3ti-482" value="<?= htmlspecialchars($username) ?>" minlength="3" maxlength="16" pattern="[A-Za-z0-9_.-]{3,16}" autocomplete="username" aria-describedby="generatedUsernamePreview usernameFeedback">
                <div id="generatedUsernamePreview" class="form-text">Nie wpisujesz loginu? Utworzymy go z imienia, inicjału nazwiska i klasy.</div>
