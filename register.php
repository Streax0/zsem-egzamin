...
function registrationRandomUsername(PDO $pdo): string {
    for ($i = 0; $i < 50; $i++) {
        $candidate = 'user_' . bin2hex(secureRandomBytes(4));
    ...
    return 'user_' . bin2hex(secureRandomBytes(4));
}
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($username === '') {
        ...
        $username = registrationRandomUsername($pdo);
    }
    ...
    <main class="auth-form-panel register-form-panel" role="main">
        ...
        <form method="POST" id="registerForm">
            ...
            <div class="mb-3">
                ...
                <input type="text" name="username" id="regUsername" class="form-control" placeholder="Puste = losowy prywatny login" value="<?= htmlspecialchars($username) ?>" minlength="3" maxlength="16" pattern="[A-Za-z0-9_.-]{3,16}" autocomplete="username">
