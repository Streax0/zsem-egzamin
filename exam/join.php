                            ...
                            <div class="dashboard-panel" data-join-code-card>
                                ...
                                <form method="POST">
                                    ...
                                    <div class="form-check mb-4">
                                        ...
                                        <label class="form-check-label small" for="privacyConsent">Wyrażam zgodę na przetwarzanie moich danych osobowych zgodnie z <a href="../privacy.php" target="_blank">Polityką Prywatności</a> w celu rejestracji udziału w sprawdzianie.</label>
                                    </div>
