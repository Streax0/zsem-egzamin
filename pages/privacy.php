...
?>
<?php
$pageTitle = 'Polityka prywatności i cookies - ZSEM Tech';
        ...
        <main role="main" class="content-body">
            <div class="container py-4" style="max-width: 960px;">
                ...
                <section class="dashboard-panel mb-4" id="cookies">
                    ...
                    <p>Platforma nie ładuje obecnie cookies analitycznych ani marketingowych stron trzecich przed uzyskaniem zgody. Pełna tabela znajduje się w <a href="pages/polityka-cookies.php">Polityce cookies</a>.</p>
                </section>
