...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    switch ($action) {
        ...
        case 'create_app_status':
            ...
            redirect('index.php#admin-statuses');
            break;
        ...
        case 'broadcast_notification':
            ...
            redirect('index.php#admin-system');
            break;
        ...
        case 'create_feature_page_block':
            ...
            redirect('index.php#admin-page-blocks');
            break;
        ...
        case 'create_sandbox_element_block':
            ...
            redirect('index.php#admin-sandbox-blocks');
            break;
        ...
        case 'delete_admin_audit_entry':
            ...
            redirect('index.php#admin-audit');
            break;
...
?>
<?php
$pageTitle = 'Panel Admina - ZSEM Egzamin';
                        ...
                        <form method="GET" class="row g-3 admin-search-form align-items-end p-4">
                            ...
                            <?php if ($search !== ''): ?>
                                <div class="col-12 col-md-auto">
                                    <a href="admin/index.php" class="btn btn-outline-secondary" style="border-radius: 8px; font-weight: 600;"><i class="bi bi-x-lg me-1"></i>Wyczyść filtry</a>
                                </div>
                            <?php endif; ?>
                        </form>
                    </div>
